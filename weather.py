...
values = {"clear", "rain", "wind", "hail", "sleet", "showers", "hurricane", "tornado", "apocolypse"} 

condition = str(random.sample(values, 1)[0]) + " with a chance of " + str(random.sample(values, 1)[0]) + "." 
